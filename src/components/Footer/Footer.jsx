...
import FooterLogo from '../../assets/lbg.png';
    ...
    <>
      <div className=" dark:bg-gray-950 py-10 relative overflow-hidden">
        ...
        <div className="container">
          ...
          <div>
            <div className="text-center py-5 border-t-2 border-gray-300/50 bg-primary text-white">@copyright 2025 All rights reserved || Made with ❤️ by Lombok</div>
          </div>
        </div>
      </div>
    </>
