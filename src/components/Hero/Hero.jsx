        ...
        <div className="container grid grid-cols-1 gap-4">
          <div className="text-white">
            ...
            <p data-aos="fade-up" data-aos-delay="300" className="text-sm">
              Discover the unparalleled beauty of Lombok with us! Enjoy unforgettable journeys to pristine white beaches, breathtaking waterfalls, and the majestic views of Mount Rinjani. We are here to help you explore every corner of this
              tropical paradise with the best travel packages and services designed for your comfort.
            </p>
            <p data-aos="fade-up" data-aos-delay="300" className="text-sm">
              Let’s create beautiful memories in Lombok together! 🌴
            </p>
          </div>
